...
function add_select_country_state() {
    ...
    if( has_term( 'rayco', 'product_cat' , $prod_id) ) {
        ...
        echo '<div class="woocommerce-info">Este producto alquilado y entregado por Distribuidora Rayco. La facturación del servicio es hecha directamente por Distribuidora Rayco. <strong>Solamente disponible en Bucaramanga.</strong></div>';
