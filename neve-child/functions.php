...
function add_select_country_state() {
    ...
    if( has_term( 'rayco', 'product_cat' , $prod_id) ) {
        ...
        echo '<div class="woocommerce-info">Este servicio de alquiler prestado, entregado y facturado por Distribuidora Rayco. <strong>Solamente disponible en Bucaramanga.</strong></div>';
